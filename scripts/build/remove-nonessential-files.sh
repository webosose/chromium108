...
essential_found_in_chr94="
    ./src/third_party/catapult/third_party
"

new_nonessential_found_in_chr108="
    ./src/tools/luci-go
    ./src/tools/resultdb
    ...
    ./src/third_party/jdk
    ./src/third_party/swiftshader/tests/regres/testlists/vk-master-NOT_SUPPORTED.txt
"

essential_found_in_chr108="
    ./src/chrome/test/data/extensions
    ./src/tools/perf/process_perf_results.pydeps
"

nonessential_softlinks="
    ./src/tools/luci-go/isolate
    ./src/tools/luci-go/swarming
    ./src/tools/luci-go/isolated
    ./src/tools/luci-go/.versions
    ./src/tools/resultdb/result_adapter
    ./src/tools/resultdb/.versions
    ./src/third_party/checkstyle/checkstyle-all.jar
"
...
rm -Rf $all_cipd_dirs_files $files_giving_yocto_warning $all_git_dirs $files_over_github_size_limit $nonessential_dirs_removed_earlier $new_nonessential_dirs $nonessential_test_dirs $fuchsia_paths $new_nonessential_found_in_chr79 $new_nonessential_third_party_test_in_chr79 $new_nonessential_third_party_tests_in_chr79 $nonessential_softlinks $new_nonessential_found_in_chr108
