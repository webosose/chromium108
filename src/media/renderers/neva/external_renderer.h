...
class MEDIA_EXPORT ExternalRenderer : public Renderer,
 ...
 public:
  ...
  ExternalRenderer(const ExternalRenderer&) = delete;
  ExternalRenderer& operator=(const ExternalRenderer&) = delete;
 ...
 private:
  ...
  bool pending_audio_read_ = false;
  bool pending_video_read_ = false;
  ...
  base::TimeDelta start_timestamp_ = base::Seconds(0);
