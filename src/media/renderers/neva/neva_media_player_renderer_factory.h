...
class MEDIA_EXPORT NevaMediaPlayerRendererFactory final
 ...
 public:
  ...
  NevaMediaPlayerRendererFactory(const NevaMediaPlayerRendererFactory&) =
      delete;
  NevaMediaPlayerRendererFactory& operator=(
      const NevaMediaPlayerRendererFactory&) = delete;
