...
class MEDIA_EXPORT EmptyBufferAudioDecoder : public AudioDecoder {
 public:
  ...
  EmptyBufferAudioDecoder() = delete;
  EmptyBufferAudioDecoder(const EmptyBufferAudioDecoder&) = delete;
  EmptyBufferAudioDecoder& operator=(const EmptyBufferAudioDecoder&) = delete;
