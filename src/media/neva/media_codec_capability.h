...
struct MEDIA_EXPORT MediaCodecCapability {
  ...
  MediaCodecCapability(const std::string& codec,
                       int width,
                       int height,
                       int frame_rate,
                       int64_t bit_rate,
  ...
  MediaCodecCapability(const MediaCodecCapability&);

  MediaCodecCapability& operator=(const MediaCodecCapability&);

  MediaCodecCapability(MediaCodecCapability&&) noexcept;

  MediaCodecCapability& operator=(MediaCodecCapability&&) noexcept;
