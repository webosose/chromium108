...
#ifndef MEDIA_NEVA_WEBOS_WEBOS_MEDIA_PIPELINE_ERROR_H_
#define MEDIA_NEVA_WEBOS_WEBOS_MEDIA_PIPELINE_ERROR_H_
...
#endif  // MEDIA_NEVA_WEBOS_WEBOS_MEDIA_PIPELINE_ERROR_H_
