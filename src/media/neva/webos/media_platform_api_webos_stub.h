...
class MEDIA_EXPORT MediaPlatformAPIWebOSStub : public MediaPlatformAPI {
 public:
  typedef base::RepeatingCallback<void(const gfx::Rect&)> ActiveRegionCB;
  MediaPlatformAPIWebOSStub();
  MediaPlatformAPIWebOSStub(const MediaPlatformAPIWebOSStub&) = delete;
  MediaPlatformAPIWebOSStub& operator=(const MediaPlatformAPIWebOSStub&) =
      delete;
