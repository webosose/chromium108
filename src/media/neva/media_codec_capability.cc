...
MediaCodecCapability::MediaCodecCapability(const std::string& codec,
                                           int width,
                                           int height,
                                           int frame_rate,
                                           int64_t bit_rate,
...
MediaCodecCapability::MediaCodecCapability(int width,
                                           ...
                                           int channels,
                                           const std::string& features)
    : MediaCodecCapability(std::string(),
                           width,
                           height,
                           frame_rate,
                           bit_rate,
...
MediaCodecCapability::MediaCodecCapability(const MediaCodecCapability&) =
    default;

MediaCodecCapability& MediaCodecCapability::operator=(
    const MediaCodecCapability&) = default;

MediaCodecCapability::MediaCodecCapability(MediaCodecCapability&&) noexcept =
    default;

MediaCodecCapability& MediaCodecCapability::operator=(
    MediaCodecCapability&&) noexcept = default;
