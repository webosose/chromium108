...
class NevaLayerOverlayProcessor {
 public:
  ...
  NevaLayerOverlayProcessor(const NevaLayerOverlayProcessor&) = delete;
  NevaLayerOverlayProcessor& operator=(const NevaLayerOverlayProcessor&) =
      delete;
  ~NevaLayerOverlayProcessor();
...
#if defined(USE_NEVA_MEDIA)
  ui::VideoWindowGeometryManager* video_window_geometry_manager_ = nullptr;
#endif
