...
class MojoMediaPlatformAPIService : public mojom::MediaPlatformAPI {
 public:
  using ActiveRegionCB = base::RepeatingCallback<void(const gfx::Rect&)>;
  using VideoSizeChangedCB =
      base::RepeatingCallback<void(const gfx::Size&, const gfx::Size&)>;
  using PlayerEventCB = base::RepeatingCallback<void(media::PlayerEvent)>;
  ...
  void Initialize(
      const absl::optional<media::AudioDecoderConfig>& maybe_audio_config,
      const absl::optional<media::VideoDecoderConfig>& maybe_video_config,
