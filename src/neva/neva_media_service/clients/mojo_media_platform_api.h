...
class COMPONENT_EXPORT(NEVA_MEDIA_SERVICE) MojoMediaPlatformAPI
 ...
 public:
  ...
  void OnPipelineStatusChanged(const media::PipelineStatus& status) override;
 ...
 private:
  ...
  void OnCreate();
  void OnInitialized(const media::PipelineStatus& status);
  ...
  mojo::Remote<mojom::MediaPlatformAPI> media_platform_api_;
