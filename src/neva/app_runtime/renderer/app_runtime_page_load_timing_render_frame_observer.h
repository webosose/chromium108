...
class AppRuntimePageLoadTimingRenderFrameObserver
 ...
 private:
  ...
  absl::optional<base::TimeDelta> loading_end_;
  absl::optional<base::TimeDelta> first_paint_;
  absl::optional<base::TimeDelta> first_contentful_paint_;
  absl::optional<base::TimeDelta> first_text_paint_;
  absl::optional<base::TimeDelta> first_image_paint_;
  absl::optional<base::TimeDelta> first_meaningful_paint_;
  absl::optional<base::TimeDelta> largest_contentful_paint_;
  absl::optional<uint64_t> largest_contentful_paint_size_;
};
