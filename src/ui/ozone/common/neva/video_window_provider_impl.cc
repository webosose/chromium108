...
class VideoWindowMojo : public mojom::VideoWindow {
 public:
  ...
  void CommitVideoWindowGeometryIfNeeded(const gfx::Rect& src,
                                         const gfx::Rect& dst,
                                         const absl::optional<gfx::Rect>& ori);
 ...
 private:
  ...
  gfx::Rect src_rect_;
  gfx::Rect dst_rect_;
  absl::optional<gfx::Rect> ori_rect_ = absl::nullopt;
  absl::optional<gfx::Size> coded_size_;
  absl::optional<gfx::Size> natural_size_;
...
void VideoWindowMojo::UpdateVideoWindowGeometry(const gfx::Rect& dst) {
  CommitVideoWindowGeometryIfNeeded(src_rect_, dst, absl::nullopt);
}
...
void VideoWindowMojo::CommitVideoWindowGeometry() {
  ...
  absl::optional<gfx::Size> video_size;
...
void VideoWindowMojo::UpdateVideoWindowGeometry(const gfx::Rect& src,
  ...
  CommitVideoWindowGeometryIfNeeded(src, dst, absl::nullopt);
}
