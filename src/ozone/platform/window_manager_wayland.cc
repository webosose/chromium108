...
void WindowManagerWayland::ButtonNotify(unsigned handle,
  ...
  base::ThreadTaskRunnerHandle::Get()->PostTask(
      FROM_HERE,
      base::BindOnce(&WindowManagerWayland::NotifyButtonPress,
...
void WindowManagerWayland::CloseWidget(unsigned handle) {
  base::ThreadTaskRunnerHandle::Get()->PostTask(
      FROM_HERE,
      base::BindOnce(&WindowManagerWayland::OnWindowClose,
...
void WindowManagerWayland::WindowUnminimized(unsigned handle) {
  base::ThreadTaskRunnerHandle::Get()->PostTask(
      FROM_HERE,
      base::BindOnce(&WindowManagerWayland::OnWindowUnminimized,
                     weak_ptr_factory_.GetWeakPtr(), handle));
}
...
void WindowManagerWayland::WindowDeActivated(unsigned windowhandle) {
  base::ThreadTaskRunnerHandle::Get()->PostTask(
      FROM_HERE,
      base::BindOnce(&WindowManagerWayland::OnWindowDeActivated,
...
void WindowManagerWayland::WindowActivated(unsigned windowhandle) {
  base::ThreadTaskRunnerHandle::Get()->PostTask(
      FROM_HERE,
      base::BindOnce(&WindowManagerWayland::OnWindowActivated,
                     weak_ptr_factory_.GetWeakPtr(), windowhandle));
}
...
void WindowManagerWayland::DragEnter(
  ...
  base::ThreadTaskRunnerHandle::Get()->PostTask(
      FROM_HERE,
      base::BindOnce(&WindowManagerWayland::NotifyDragEnter,
...
void WindowManagerWayland::DragLeave(unsigned windowhandle) {
  base::ThreadTaskRunnerHandle::Get()->PostTask(
      FROM_HERE,
      base::BindOnce(&WindowManagerWayland::NotifyDragLeave,
                     weak_ptr_factory_.GetWeakPtr(), windowhandle));
}
...
void WindowManagerWayland::InputPanelRectChanged(unsigned windowhandle,
                                                 ...
                                                 uint32_t height) {
  base::ThreadTaskRunnerHandle::Get()->PostTask(
      FROM_HERE, base::BindOnce(&WindowManagerWayland::NotifyInputPanelRectChanged,
                                weak_ptr_factory_.GetWeakPtr(), windowhandle,
                                x, y, width, height));
}
...
void WindowManagerWayland::WindowClose(unsigned windowhandle) {
  base::ThreadTaskRunnerHandle::Get()->PostTask(
      FROM_HERE,
      base::BindOnce(&WindowManagerWayland::NotifyWindowClose,
                     weak_ptr_factory_.GetWeakPtr(), windowhandle));
}
...
void WindowManagerWayland::KeyboardEnter(unsigned windowhandle) {
  base::ThreadTaskRunnerHandle::Get()->PostTask(
      FROM_HERE,
      base::BindOnce(&WindowManagerWayland::NotifyKeyboardEnter,
          weak_ptr_factory_.GetWeakPtr(), windowhandle));
}
...
void WindowManagerWayland::KeyboardLeave(unsigned windowhandle) {
  base::ThreadTaskRunnerHandle::Get()->PostTask(
      FROM_HERE,
      base::BindOnce(&WindowManagerWayland::NotifyKeyboardLeave,
          weak_ptr_factory_.GetWeakPtr(), windowhandle));
}
...
void WindowManagerWayland::NativeWindowStateAboutToChange(unsigned handle,
  ...
  base::ThreadTaskRunnerHandle::Get()->PostTask(
      FROM_HERE,
      base::BindOnce(&WindowManagerWayland::NotifyNativeWindowStateAboutToChange,
