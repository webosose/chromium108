...
void InputMethodContextManager::Commit(unsigned handle, const std::string& text) {
  base::ThreadTaskRunnerHandle::Get()->PostTask(
      FROM_HERE,
      base::BindOnce(&InputMethodContextManager::NotifyCommit,
...
void InputMethodContextManager::PreeditEnd() {
  base::ThreadTaskRunnerHandle::Get()->PostTask(
      FROM_HERE,
      base::BindOnce(&InputMethodContextManager::NotifyPreeditEnd,
...
void InputMethodContextManager::PreeditStart() {
  base::ThreadTaskRunnerHandle::Get()->PostTask(
      FROM_HERE,
      base::BindOnce(&InputMethodContextManager::NotifyPreeditStart,
                     weak_ptr_factory_.GetWeakPtr()));
}
