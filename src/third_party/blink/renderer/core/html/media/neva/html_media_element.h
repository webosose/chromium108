...
class HTMLMediaElement {
 ...
 protected:
  ...
  absl::optional<bool> has_noaudio_attr_ = absl::nullopt;
};
...
class HTMLMediaElementExtendingWebMediaPlayerClient
 ...
 public:
  ...
  absl::optional<bool> IsAudioDisabled() const override;
...
WebString HTMLMediaElementExtendingWebMediaPlayerClient<original_t>::Cookies()
  ...
  backend->GetCookiesString(
      ...
      /*partitioned_cookies_runtime_feature_enabled=*/false, &value);

  return value;
}

template <typename original_t>
absl::optional<bool> HTMLMediaElementExtendingWebMediaPlayerClient<
